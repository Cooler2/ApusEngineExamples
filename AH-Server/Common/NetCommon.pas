...
// name:=' '+name+' ';
 ...
 if (posFrom(WideString('pizd'),wname,1,true)>0) or
    (posFrom(WideString('fuck'),wname,1,true)>0) or
    (posFrom(WideString('(Bot)'),wname,1,true)>0) or
    (posFrom(WideString('pidor'),wname,1,true)>0) then result:='^This name is not allowed^';
end;
